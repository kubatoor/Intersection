...
public class Line implements Shape {
	...
	public boolean doIntersect(Shape shape) {
		if(shape instanceof Circle)
			return IntersectionUtility.doIntersect(this,(Circle) shape);
		else if(shape instanceof Polygon)
			return IntersectionUtility.doIntersect((Polygon) shape, this);
		else if(shape instanceof Line)
			return IntersectionUtility.doIntersectLineSegments(this, (Line) shape);
		else
